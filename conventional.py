...
merged_model1.compile(loss='cross-entropy' , optimizer= 'adam',metrics=['binary_accuracy'] )
j=0
i=0
...
# Fit the model
def modelf1():
	m1=merged_model1.fit([X_train1, X_train2], y_train, nb_epoch=1, batch_size=100, verbose=2, shuffle=True)
	return m1
...
def modelp1():
	p1=merged_model1.predict([X_test1, X_test2])
	return p1
